...
public record GroupLastChatMessageDTO(@NotNull Long id,
                                      @NotBlank String name,
                                      String thumbnailUrl,
                                      @NotNull Integer numOfMembers,
                                      @NotBlank String lastChatMessage) {

    public static GroupLastChatMessageDTO fromEntity(Group group, ChatMessage chatMessage) {
        return new GroupLastChatMessageDTO(
                group.getId(),
