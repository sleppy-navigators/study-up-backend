...
@Component
public class TaskCertifyNotificationMessageGenerator implements NotificationMessageGenerator<TaskCertifyEvent> {

    private static final String TITLE = "테스크 인증 알림";
    private static final String MESSAGE_FORMAT = "%s님이 '%s' 테스크를 인증했습니다. (%s)";

    @Override
    public NotificationMessage generate(TaskCertifyEvent event) {
